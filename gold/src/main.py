...
Transformer().run(meter_values_request_df=meter_values_request_df, start_transaction_request_df=start_transaction_request_df, start_transaction_response_df=start_transaction_response_df, stop_transaction_request_df=stop_transaction_request_df, output_directory=f"{dir_path}/../output")
